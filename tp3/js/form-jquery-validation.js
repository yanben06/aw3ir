$(document).ready(function () {
    $("form").on("submit", function (event) {
        ...
        if(error == ""){
            ...
            $(".modal-body").html('<img src="https://maps.googleapis.com/maps/api/staticmap?markers=Arcueil&zoom=10&size=400x300&scale=2&key=AIzaSyAkmvI9DazzG9p77IShsz_Di7-5Qn7zkcg"/ width="4%" >');
